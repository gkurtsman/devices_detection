...
$OPENVINO/samples/cpp/build_samples/intel64/Debug/object_detection_sample_ssd \
-m  $OPENVINO/openvino_env/lib/python3.8/site-packages/openvino/model_zoo/models/intel/vehicle-detection-0202/FP32/vehicle-detection-0202.xml \
-i $FL1 \
-d CPU
