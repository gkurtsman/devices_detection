python -m pdb /opt/intel/openvino_install_git/./openvino_env/lib/python3.8/site-packages/openvino/tools/mo/main.py \
...
'--output=feature_vector,saliency_map,labels,boxes --data_type=FP32' \
'--input_shape=[1, 3, 864, 864]'
